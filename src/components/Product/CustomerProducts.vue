                ...
                <v-list-tile avatar v-bind:key="item.title">
                    ...
                    <v-list-tile-content>
                        ...
                        <v-list-tile-sub-title>
                            <v-btn large @click="addBundleToCart" class="success">全てカートに入れる</v-btn>
                        </v-list-tile-sub-title>
                    </v-list-tile-content>
                </v-list-tile>
            </v-list>
                        ...
                        <v-flex xs7>
                            <router-link :to="'/products/' + product.id" tag="span" style="cursor: pointer">
                                ...
                                <div class="text-xs-left">
                                    <v-chip v-for="tag in product.tags" label outline :key="product.id + tag"
    ...
    export default {
      ...
      data () {
        return {
          ...
          errorMsg: 'test',
          item: {
            avatar: 'https://topical.jp/img/no_avatar.png',
